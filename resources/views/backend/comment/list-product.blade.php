...
<?php
  if ($stt==1){
   $comments = App\CommentFrame::select('comment_frames.*','accounts.username','frames.name')->leftJoin('accounts', 'comment_frames.account_id', '=', 'accounts.id')->where('comment_frames.status',0)->leftJoin('frames', 'frames.id', '=', 'comment_frames.frame_id')->orderby('created_at','asc')->paginate(10); 
  }
?>
 ...
 <div class="app-body" id="view">
    <div class="padding">
      <div class="box">
        ...
        <div class="box-body">
          <form action="{!! route('search.cmpro') !!}" method="get">
