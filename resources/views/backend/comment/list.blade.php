          ...
          <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{$value->comment}}</td>
                  <td>
                  <div style="min-width:80px;color:blue">@for($i=0;$i< intval($value->rating);$i++)
                  <i class="fa fa-star t-blue-text"></i>
                  @endfor
                  </div>
                  </td>
                  <td><a style="color:blue" href="{{route('frontend.san-pham.slug',['id'=>$value->product_id,'slug'=>$value->slug])}}" target="_blank">{{$value->name}}</a></td>
