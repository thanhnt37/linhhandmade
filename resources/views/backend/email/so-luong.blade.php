...
<body bgcolor="#ffffff">
  ...
  <div align="center">
    <table class="head-wrap w320 full-width-gmail-android" bgcolor="#f8f8f8" cellpadding="0" cellspacing="0" border="0">
      <tr>
    ...
    <table class="body-wrap w320" style="background-color:#f2f2f2;width:100% !important" >
      <tr>
        <td></td>
        <td class="container" style="max-width:100% !important">
          <div class="content">
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                                Đã có sản phẩm mới bạn mong đợi
                            </td>
                          </tr>
                        </table>
                        <div>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
								...
								<p>Mã Sản Phẩm:{!! $frame->code_frame !!}</p>
								<p><a href="{!! $link !!}">Xem chi tiết </a></p>
								<p>Trân trọng!</p>
      ...
      <tr>
        ...
        <td class="container" style="max-width:100% !important">
          <div class="content footer-lead">
            <a href="#"><b>Liên hệ với chúng tôi</b></a> nếu bạn có bất kì thắc mắc gì
          </div>
        </td>
        <td></td>
      </tr>
