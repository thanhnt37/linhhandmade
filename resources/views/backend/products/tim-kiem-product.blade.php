    ...
    <div style="float:left;" class="title_form">
        @if($cate) 
          ...
          @if(session('admin')->can('them_san_pham') || session('admin')->can('luu_san_pham'))
              <a href="{{ route('product.create.product') }} " class="p-themmoi1"></a>
            @endif
        @else
          <p>
          <!-- phong -->
    ...
    <div class="padding">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <button class="number-post d-list1">{!! sizeof($frame) !!} SP</button>
                        ...
                        @for ($i = 1; $i <= $frame->lastPage(); $i++)
                          ...
                          @if ($from < $i && $i < $to)
                              <li class="{{ ($frame->currentPage() == $i) ? ' active' : '' }}">
                                  <a  class="{{ ($frame->currentPage() == $i) ? ' active' : '' }}" href="{{$frame->url($i)}}&name={!! $search !!}" data-page={{$i}}>{{ $i }}</a>
                              </li>
                          @endif
                        @endfor
                    </ul>
