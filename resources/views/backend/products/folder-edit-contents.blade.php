...
@endsection
@section('content')
<form ui-jp="parsley" method="post" action="{{route('submit-folder-content')}}" enctype="multipart/form-data" id="form-add-product">
<div class="app-header white box-shadow">
<div class="navbar">
		<div style="float:left;" class="title_form">
	      <p>Chỉnh sửa {{$group->name}}</p>
	    </div>
	 ...
	 <div class="app-body" id="view">
	 	...
	 	<div class="padding">
			 	<div class="row masonry-container">
									...
									<div class="col-sm-12">
							            ...
							            <div class="form-group">
								              <p style="margin-bottom:10px;line-height:0px">
								               <img id="img_preview" style="max-height:200px;" @if($group->img) src="{{$group->img}}" @endif >
								              </p>
							...
							<div class="row">
								<div class="col-sm-12" style="">
									<div class="form-group">
						              ...
						              <input type="text" class="form-control" name="group_name" autocomplete="off" value="{{$group->name}}" >
						            </div>
						            <div class="form-group">
						              <label>Mô tả ngắn</label>
						              <textarea name="group_des" class="form-control" rows="5">{{$group->description}}</textarea>
						            </div>
								</div>
				         	</div>	 
		                  </div>
							           	...
							           	<div class="tab-content" id="list_tab_content">      
										    <div class="tab-pane p-v-sm active" id="tab_1">
										      <div class="box m-t p-a-sm">
									              ...
									              <textarea  id="editor_1" class="form-control" rows="5" name="post_content">{{$group->contents}}</textarea>
									            </div>
									          </div>
									        </div>
										</div>       	
				    ...
				    <!-- End Item -->
				    <!-- Begin Item youtube -->
				    <?php $links_yt = json_decode($group->youtube_links);?>
				    <div class="col-sm-6 item">
				        <div class="box">
  ...
  <script>
	...
	$(function() {
	    ...
	    $("div#myDropZone").dropzone({
	            ...
	            addRemoveLinks : true,
			    maxFilesize: 5,
			    dictDefaultMessage: 'Ảnh chi tiết danh mục',
	    ...
	    <?php
	     	$images = json_decode($group->image_links);
	    ?>
			...
			@foreach($images as $img)
				  ...
				  var myFile = {
					    ...
					    @if(file_exists(public_path().''.$img))
					    	size: "{!! filesize(public_path().''.$img) !!}"
					    @endif
				  };
				  myDropzone.emit("addedfile", myFile);
			      myDropzone.createThumbnailFromUrl(myFile, '{{asset($img)}}');
