	 ...
	 <div class="app-body" id="view">
	 	...
	 	<div class="padding">
			 	 <div class="row masonry-container">
				    ...
				    <div class="col-sm-6 item">
				        <div class="box">
				          <div class="box-header"><h2>Thêm thuộc tính định tính</h2>
				    ...
				    <div class="col-sm-6 item">
				        <div class="box">
				          <div class="box-header"><h2>Thêm thuộc tính định lượng</h2>
							...
							<div class="row">
								<div class="col-sm-12" style="">
									<div class="form-group m-money">
						              ...
						              <input  type="text" class="form-control" name="price" value="{{ $frame->price_sale }}" autocomplete="off" >
							...
							<div class="row">
								<div class="col-sm-12" style="">
									<div class="form-group">
						              ...
						              <input type="text" class="form-control" name="code_frame"  value="{{$code}}" autocomplete="off" >
						            </div>
							...
							<div class="row">
								<div class="col-sm-12" id="add_youtube_containner">
									...
									<div class="form-group link_youtube" >
						              ...
						              <i class="material-icons md-24 close_yt">&#xe147;</i>
						            </div>
						            @endforeach
						            @endif
								</div>
