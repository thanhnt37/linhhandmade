      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="dropdown-menu pull-right">
             <a  class="dropdown-item" href="{{route('tags.list')}}">Tất cả</a>
            @foreach($list_categories as $v0)
              <a  class="dropdown-item" href="{{route('tags.detail.cate',['id'=>$v0->id])}}">{{$v0->name}}</a>
              @if($v0->subcategory)
                   @foreach($v0->subcategory as $v1)
                        <a  class="dropdown-item"  href="{{route('tags.detail.cate',['id'=>$v1->id])}}">{{$space}}{{$v1->name}}</a>
                        @if($v1->subcategory)
                          @foreach($v1->subcategory as $v2)
                            <a  class="dropdown-item"  href="{{route('tags.detail.cate',['id'=>$v2->id])}}">{{$space.$space}}{{$v2->name}}</a>
                                @if($v2->subcategory)
                                @foreach($v2->subcategory as $v3)
                                  <a  class="dropdown-item" href="{{route('tags.detail.cate',['id'=>$v3->id])}}">{{$space.$space.$space}}{{$v3->name}}</a>
                                  @if($v3->subcategory)
                                     @foreach($v3->subcategory as $v4)
                                      <a  class="dropdown-item" href="{{route('tags.detail.cate',['id'=>$v4->id])}}">{{$space.$space.$space.$space}}{{$v4->name}}</a>
                                     @endforeach
                                 @endif
                                 @endforeach
                             @endif
              ...
              <tr>
                 ...
                 <!--  <td>
                  ...
                  <td class="action-post">
                    ...
                    <a class="edit" href="#" type="button" data-id="{{$value->id}}">
                    Sửa
                    </a>
                    <a href="#" type="submit" id="xoa-tag" data-id="{{$value->id}}">
                    Xóa
                    </a>
                  </td>
